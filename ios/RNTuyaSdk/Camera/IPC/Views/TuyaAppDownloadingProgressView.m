//
//  TuyaAppDownloadingProgressView.m
//  TuyaSDK
//
//  Created by Nagaraj Balan on 06/12/20.
//

#import "TuyaAppDownloadingProgressView.h"
...
@interface TuyaAppDownloadingProgressView ()
...
@implementation TuyaAppDownloadingProgressView
...
- (UIView *)rectView {
    if (!_rectView) {
        ...
        _rectView.backgroundColor = [[TuyaAppViewUtil colorWithHexString:@"#303030"] colorWithAlphaComponent:0.6];
    }
    return _rectView;
}
...
- (DACircularProgressView *)progressView {
    if (!_progressView) {
        ...
        _progressView.trackTintColor = [TuyaAppViewUtil colorWithHexString:@"#535353"];
