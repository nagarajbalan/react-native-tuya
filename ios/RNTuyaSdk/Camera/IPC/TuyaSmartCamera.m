...
- (void)startPlaybackWithPlayTime:(NSInteger)playTime timelineModel:(TuyaAppCameraTimeLineModel *)model success:(IPCVoidBlock)success failure:(IPCErrorBlock)failure {
